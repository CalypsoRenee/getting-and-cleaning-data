...
2. [run_analysis.R](https://github.com/calypsorenee/getting-and-cleaning-data//run_analysis.R) (the R script that contains the transformations)
3. [CodeBook.md](https://github.com/calypsorenee/getting-and-cleaning-data//Codebook.md) (describes the variables, the data, the transformations, and the work that is performed to clean up the data)

### Script ([run_analysis.R](https://github.com/calypsorenee/getting-and-cleaning-data//run_analysis.R))
...
[run_analysis.R](https://github.com/calypsorenee/getting-and-cleaning-data//run_analysis.R) goes through the following process to meet the project requirements. Please review the script for further insight.
